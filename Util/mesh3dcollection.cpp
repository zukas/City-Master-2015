...
uint32_t Mesh3DCollection::create(const obj_3d_vertex *vertexes,
    ...
    glBufferData(GL_ARRAY_BUFFER, vertexe_size * sizeof(obj_3d_vertex), vertexes,
                 GL_STATIC_DRAW);
...
uint32_t Mesh3DCollection::create(const uv_3d_vertex *vertexes, uint32_t vertexe_size, const uint32_t *indexes, uint32_t index_size)
{
	uint32_t vertex_array_;
	uint32_t buffer_[2];
