...
int check_extenstion(const char *name)
{
    int found = -1;
    int numExt = 0;
    int i;
...
int query_NPOT_capability( void )
{
	...
	if( has_NPOT_capability == SOIL_CAPABILITY_UNKNOWN )
	{
        ...
        if(check_extenstion("GL_ARB_texture_non_power_of_two") == 0)
		{
            /*	it's there!	*/
...
int query_tex_rectangle_capability( void )
{
	...
	if( has_tex_rectangle_capability == SOIL_CAPABILITY_UNKNOWN )
	{
		/*	we haven't yet checked for the capability, do so	*/
        if(
                check_extenstion("GL_ARB_texture_rectangle") != 0 &&
                check_extenstion("GL_EXT_texture_rectangle") != 0 &&
                check_extenstion("GL_NV_texture_rectangle") != 0
                )
		{
			/*	not there, flag the failure	*/
...
int query_cubemap_capability( void )
{
	...
	if( has_cubemap_capability == SOIL_CAPABILITY_UNKNOWN )
	{
		/*	we haven't yet checked for the capability, do so	*/
        if(
                check_extenstion("GL_ARB_texture_cube_map") != 0 &&
                check_extenstion("GL_EXT_texture_cube_map") != 0
                )
		{
			/*	not there, flag the failure	*/
...
int query_DXT_capability( void )
{
	...
	{
		/*	we haven't yet checked for the capability, do so	*/
        if( check_extenstion("GL_EXT_texture_compression_s3tc") != 0)
		{
			/*	not there, flag the failure	*/
