...
{
	return {    1.f, 0.f, 0.f, translate.x,
...
glm::mat4 transform_mat4(const glm::quat &rotation, const glm::vec3 &translation, const glm::vec3 &scale, const glm::mat4 &base)
{
	return base * ((glm::scale(glm::mat4(1.f), scale) * glm::mat4_cast(rotation)) * glm::translate(glm::mat4(1.f), translation));
}
